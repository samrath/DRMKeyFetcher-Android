...
@TargetApi(18)
 class DRMDefaultDrmSession<T extends ExoMediaCrypto> implements DrmSession<T> {
    ...
    public interface ProvisioningManager<T extends ExoMediaCrypto> {
         ...
         * <em>will</em> call {@link DRMDefaultDrmSession#onProvisionCompleted()} when provisioning has
         * completed, or {@link DRMDefaultDrmSession#onProvisionError} if provisioning fails.
         *
         * @param session The session.
         */
        void provisionRequired(DRMDefaultDrmSession<T> session);
    ...
    private static final String TAG = "DRMDefaultDrmSession";
        ...
        if (--openCount == 0) {
            ...
            if (sessionId != null) {
                ...
                if (DRMDefaultDrmSessionEventListener !=null){
                    DRMDefaultDrmSessionEventListener.onDrmSessionReleased();
                }
            }
            return true;
        }
    ...
    private boolean openInternal(boolean allowProvisioning) {
        ...
        try {
            ...
            if (DRMDefaultDrmSessionEventListener !=null){
                DRMDefaultDrmSessionEventListener.onDrmSessionAcquired();
            }
            ...
            case DefaultDrmSessionManager.MODE_QUERY:
                if (offlineLicenseKeySetId == null) {
                    ...
                    if (mode == DefaultDrmSessionManager.MODE_PLAYBACK
                        ...
                        if (DRMDefaultDrmSessionEventListener !=null){
                            DRMDefaultDrmSessionEventListener.onDrmKeysRestored();
                        }
                    }
                }
                break;
    ...
    private void onKeyResponse(Object request, Object response) {
        ...
        try {
            ...
            if (mode == DefaultDrmSessionManager.MODE_RELEASE) {
                ...
                state = STATE_OPENED_WITH_KEYS;
                if (DRMDefaultDrmSessionEventListener !=null){
                    DRMDefaultDrmSessionEventListener.onDrmKeysLoaded(offlineLicenseKeySetId);
                }
            }
        } catch (Exception e) {
            onKeysError(e);
